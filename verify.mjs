...
assert.match(html, /request-detail-grid/);
assert.match(html, /<th class="col-request">Request<\/th>/);
assert.match(html, /formatTrackValue/);
assert.match(html, /id="track-submit">Submit Request/);
assert.match(html, /navTo\(\{ view: 'submit', cat: currentTrackCat \}\)/);
