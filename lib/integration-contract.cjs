...
module.exports = Object.freeze({
  ...
  canonical: {
    ...
    areas: ['Property-wide', 'Content', 'Guest Services', 'Front Office', 'Lobby', 'Elevator', 'Elevator / Vestibule', 'Lovebirds', 'Lovebirds Habitat', 'Pool & Beach', 'Citrus Shack', 'Julene', 'Knook', 'Engineering', 'Guestrooms', 'Corridors', 'HR', 'Housekeeping', 'Sales', 'Merchandise', 'Minibar / IRD'],
